...
class Proxy:
    ...
    def __setattr__(self, key, value):
        if key != "attribute_list" and key != "_obj":
    ...
    def was_called(self, meth):
        return meth in self.attribute_list

    def number_of_times_called(self, meth):
        return self.attribute_list.count(meth)
